...
def z2r(z, a=200., b=1.6):
    ...
    a, b : Parameters of the Z/R relationship
            Standard values according to Marshall-Palmer are a=200., b=1.6
            The German Weather Service uses a=256 and b=1.42 instead
...
def z2rEnhanced(z):
    ...
    Returns
    -------
    r, si : r  - array of shape z.shape - calculated rain rates
