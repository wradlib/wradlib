...
of polarimetric moments is implemented in the corresponding wradlib modules, e.g.:
    ...
    - fuzzy echo classification from polarimetric moments (:doc:`classify_echo_fuzzy
...
def unfold_phi(phidp, rho, width=5, copy=False):
    ...
    phidp = speedup.f_unfold_phi(phidp=phidp.astype("f4"), rho=rho.astype("f4"),
                                 gradphi=gradphi.astype("f4"), stdarr=stdarr.astype("f4"),
...
def contiguous_regions(condition):
    ...
    This function was adopted from http://stackoverflow.com/questions/4494404/\
